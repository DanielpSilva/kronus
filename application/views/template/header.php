...
<head>
    ...
    <meta name="msapplication-TileImage" content="<?php echo base_url(); ?>public/assets/ms-icon-144x144.png">
    ...
    <link href="<?php echo base_url(); ?>public/assets/css/style2.css" rel="stylesheet">
    <!-- Slick -->
