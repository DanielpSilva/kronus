  ...
  <div class="footer-top">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-12 footer-contact my-auto">
          <h1>Kronus Tecnologia</h1>
        </div>
...
<!--
        ...
        <div class="col-lg-4 col-md-12 footer-newsletter">
          ...
          <form action="https://formsubmit.co/contato@kronustecnologia.com.br" method="POST">
            ...
            <input class="form-control" placeholder="Seu telefone" name="phone" id="phone"/>
            <input class="form-control" placeholder="Seu e-mail" type="email" name="email" id="email" required />
            <textarea class="form-control" placeholder="Mensagem" name="mensage" id="mensage" rows="5"></textarea>
  ...
  <div class="container d-md-flex py-4">
    ...
    <div class="mr-md-auto text-center text-md-left">
      <div class="copyright">
        &copy; Copyright <strong><span>Kronus Tecnologia</span></strong>. Todos os direitos reservados
      </div>
    </div>
    <div class="social-links text-center text-md-right pt-3 pt-md-0">
      <a href="https://www.facebook.com/kronustecnologia" class="facebook"><i class="bx bxl-facebook"></i></a>
      <a href="https://www.instagram.com/kronustecnologia/" class="instagram"><i class="bx bxl-instagram"></i></a>
      <a href="https://www.linkedin.com/company/kronus-tecnologia" class="linkedin"><i class="bx bxl-linkedin"></i></a>
    </div>
  </div>
</footer>

<a href="#" class="back-to-top"><i class="bx bx-up-arrow-alt"></i></a>
<a href="https://api.whatsapp.com/send?phone=5512996072735&text=Ol%C3%A1%2C%20vim%20pelo%20site%20da%20Kronus%2C%20vamos%20conversar%3F" class="float" target="_blank">
